...
class View
{
    ...
    */  
    ...
    { 
        ...
        usleep(100);
        $data['uniq']  = $uniq = md5(microtime(true));
    ...
    */  
    ...
    /**
    * Returns a listing of the contents of a class
    *
    * @param array $data
    *
    * @return string
    ...
    public function createListingClass($data)
    {
        ...
        if (!empty($amount)) {
            ...
            $data['lines'] = $scripts 
                           ...
                           . implode('<br>', $arrNoAnn)
                           .'</span>';
            $data['total'] = '<span id="visible_ann"><a href="#" onclick="return abcVisibleAllAnnot('
                           . (count($arrStr) + $cntAnn * 2) .','. $cntAnn .')">'
                           . $this->openAllAnnotationImg() .'</a></span>'
                           . '<span id="hide_ann" style="display:none"><a href="#" onclick="return abcHideAllAnnot('
                           . $cntNoAnn .','. $cntAnn .')">'
