<?php
    ...
    */
    defined('ABC_BASE_PATH') or define('ABC_BASE_PATH', dirname(dirname(__DIR__)));

    /** 
    * Устанавливает имя директории репозитария по умолчанию.
    */
    defined('ABC_REPOSITORY_NAME') or define('ABC_REPOSITORY_NAME', basename(dirname(__DIR__)));
    ...
    */   
    spl_autoload_register(function ($class) {
        ...
        foreach ($files as $file) {   
            $file = str_replace('\\', DIRECTORY_SEPARATOR, ABC_BASE_PATH . DIRECTORY_SEPARATOR . $file .'.php');
