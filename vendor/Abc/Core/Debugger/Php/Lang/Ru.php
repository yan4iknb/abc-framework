...
class Ru
{
    protected static function errorReportings() 
    {
        return [ 'Undefined variable:(.+)'        => 'Undefined variable:<b>$1</b><br /><span style="color:#400080">(Не определена переменная: <b>$1</b>)</span><br />',
                 ...
                 'Use of undefined constant (.+?) assumed (.+)' => 'Use of undefined constant <b>$1</b>  assumed <b>$2</b> <br /><span style="color:#400080">(Используется неопределенная константа <b>$1</b>, предполагается <b>$2</b>)</span><br />',
                 'Use of undefined constant' => 'Use of undefined constant <br /><span style="color:#400080">(Используется неопределенная константа)</span>',
